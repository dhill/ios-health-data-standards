...
@implementation CDAEncounterImporter


- (CDAEncounterImporter *)init:(CDAEntryFinder *)finder {
    ...
    CDAEncounterImporter *importer = [super init:finder];
