...
@implementation CDAImmunizationImporter


- (CDAImmunizationImporter *)init:(CDAEntryFinder *)finder {
     
    if (finder) {
        finder = [[CDAEntryFinder alloc] init:@"//cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.22.2.2']/cda:entry"];
    }
    CDAImmunizationImporter *importer = [super init:finder];
