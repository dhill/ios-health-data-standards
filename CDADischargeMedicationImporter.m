//
//  CDADischargeMedicationImporter.m
//  HealthDataStandards
//
...
@implementation CDADischargeMedicationImporter

- (CDADischargeMedicationImporter *)init:(CDAEntryFinder *)finder {
    ...
    CDADischargeMedicationImporter *importer = [super init:finder];
