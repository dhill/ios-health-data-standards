...
@implementation CDAProcedureImporter

- (CDAProcedureImporter *)init:(CDAEntryFinder *)finder {
    ...
    CDAProcedureImporter *importer = [super init:finder];
