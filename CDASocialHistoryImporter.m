...
@implementation CDASocialHistoryImporter

- (CDASocialHistoryImporter *)init:(CDAEntryFinder *)finder {
    ...
    CDASocialHistoryImporter *importer = [super init:finder];
