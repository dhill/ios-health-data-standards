...
@implementation CDAVitalSignsImporter

- (CDAVitalSignsImporter *)init:(CDAEntryFinder *)finder {
    ...
    CDAVitalSignsImporter *importer = [super init:finder];
